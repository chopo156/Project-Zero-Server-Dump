...
-- 			notification("~g~El mecanico esta arreglando tu vehiculo!")
-- 			return
-- 		end
...
-- 				notification("~g~" .. repairCfg.fixMessages[fixMessagePos] .. ", ahora ve al mecanico!")
-- 				fixMessagePos = fixMessagePos + 1
-- 				if fixMessagePos > repairCfg.fixMessageCount then fixMessagePos = 1 end
-- 			else
-- 				notification("~r~Tu vehiculo esta demasiado roto, es imposible arreglarlo!")
-- 			end
-- 		else
...
-- 		end
-- 	else
-- 		notification("~y~Tienes que estar dentro del vehiculo para repararlo")
-- 	end
-- end)

RegisterNetEvent('iens:notAllowed')
AddEventHandler('iens:notAllowed', function()
	notification("~r~No tienes permiso para arreglar vehiculos")
end)
