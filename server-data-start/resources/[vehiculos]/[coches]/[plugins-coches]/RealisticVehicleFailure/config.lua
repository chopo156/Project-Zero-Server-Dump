...
repairCfg = {
	...
	fixMessages = {
		"Has puesto el tanque del aceite dentro ",
		"Has parado la fuga de aceite usando un chicle",
		"Has reparado el tubo del aceite con cinta ",
		"Has pateado el motor y mágicamente ha vuelto a la vida",
		"Has apretado la tuerca de la junta de la trócola y ha dejado de gotear",
		"Has quitado algo de óxido de la bujía",
		"Has gritado a tu vehículo, algo hizo efecto"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Has comprobado el tapón del aceite. Sigue en su sitio",
		"Has mirado el motor, se ve bien",
		"Has comprobado que la cinta siga aguantando el motor",
		"Has subido el sonido de la radio, ya no se escucha el ruido del motor",
		"Has comprobado que la junta de la trócola, no gotea",
		"Has echado un antioxidante, la bujía enciende bien",
		"Nunca arregles algo que no está roto, dijeron. No me escuchaste. Al menos no empeoró"
	},
	noFixMessageCount = 6
}
