...
--     if args[1] == '0' then
-- 		holster = 0
-- 		ESX.ShowNotification('Pistola en el pantalon')
-- 	-- Chain 8
--     elseif args[1] == '1' then
-- 		holster = 1
-- 		ESX.ShowNotification('Pistola en funda (cintura)')
-- 	-- Chain 6
--     elseif args[1] == '2' then
-- 		holster = 2
-- 		ESX.ShowNotification('Pistola en funda (cadera)')
-- 	-- T-shirt 15
--     elseif args[1] == '3' then
-- 		holster = 3
-- 		ESX.ShowNotification('Pistola en funda (Sin t-shirt)')
-- 	elseif args[1] == '4' then
-- 		holster = 4
-- 		ESX.ShowNotification('Pistola en funda (Pierna)')
--     else
--         ESX.ShowNotification('Uso incorrecto: /holster 0-4')
--     end
-- end, false)
...
--     if args[1] == 'm' then
-- 		sex = 0
-- 		ESX.ShowNotification('Holster para Hombre')
--     elseif args[1] == 'f' then
-- 		sex = 1
-- 		ESX.ShowNotification('Holster para Mujer')
-- 	else
--         ESX.ShowNotification('Uso incorrecto: /sex m-f')
--     end
-- end, false)
...
function drawWeaponLarge(ped, newWeapon)
	...
	elseif not isNearTrunk() then
		...
		ESX.ShowNotification('Necesitas estar cerca de un maletero para sacar esa arma!')
	else
		blocked = true
		removeWeaponOnBack()
		startAnim("mini@repair", "fixing_a_ped")
...
function rackWeapon()
	...
	elseif isNearTrunk() then
		...
		ESX.ShowNotification('Necesitas estar cerca de un maletero para guardar tu arma!')
	end
	racking = false
end
