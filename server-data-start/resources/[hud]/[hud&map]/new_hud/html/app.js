...
window.onload = function() {
  var eventCallback = {
    ui: function(data) {
      ...
      if (config.showJob == true) {
        document.querySelector("#job").style.display = "block";
      }
      if (config.showJobgrade == true) {
        document.querySelector("#jobgrade").style.display = "block";
      }
      ...
      if (config.showVoice == true) {
        document.querySelector("#voicewrapper").style.display = "block";
      }
    ...
    element: function(data) {
      if (data.task == "enable" && data.value == 'society') {
        document.querySelector("#" + data.value).style.display = "inline-block";
      } else if (data.task == "disable" && data.value == 'society') {
        document.querySelector("#" + data.value).style.display = "none";
      } else if (data.task == "enable") {
    ...
    setLogo: function(data) {
      document.querySelector("#server img").setAttribute("src", data.value);
    },
    ...
    updatePlayerJobs: function(data) {
      var key = document.querySelector("#" + data.id + " span");
      var html = data.value;
      saferInnerHTML(key, html);
    },
    ...
    isTalking: function(data) {
      var voiceId = document.querySelector("#voiceback");
      if (data.value) {
    ...
    updateVehicle: function(data) {
      ...
      if (data.status == true) {
        ...
        if (vehicleLights.classList.contains(data.lights) == false) {
          ...
          if (data.lights == "high") {
            vehicleLights.querySelector("i img").src =
              "img/vehicle-lights-high.png";
          } else {
        ...
        if (vehicleSignals.classList.contains(data.signals) == false) {
          ...
          if (
            ...
            vehicleSignals
              .querySelector("i")
              .classList.add("fas", "fa-arrows-alt-h");
    ...
    toggleUi: function(data) {
      var uiID = document.querySelector("#uidStatus");
      if (data.value == true) {
    ...
    toggleMenu: function(data) {
      var uiID = document.querySelector("#toggleMenu");
      if (data.value) {
        uiID.classList.add("show");
      } else {
        uiID.classList.remove("show");
      }
    },
