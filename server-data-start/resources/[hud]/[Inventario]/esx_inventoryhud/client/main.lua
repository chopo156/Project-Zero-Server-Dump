...
function Comprobarmochila()
    ESX.TriggerServerCallback("esx_inventoryhud:getbag", function(bag)
        if bag then
            hasbag = true
        else
            hasbag = false
...
function loadPlayerInventory()
    ESX.TriggerServerCallback("esx_inventoryhud:getPlayerInventory", function(data)
            ...
            if weight > Config.Limit then
                exports['mythic_notify']:SendAlert('error', 'Inventario demasiado pesado, no puedes andar')
