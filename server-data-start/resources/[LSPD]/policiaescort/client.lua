...
function OpenPoliceBackupMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'menudeseguridad', {
    title    = 'GuardaEspalda',
    align    = 'top-right',
    elements = {
      {label = 'Spawnear Un Seguridad', value = 'spawn'},	
      {label = 'Spawnear Dos Seguridad', value = 'spawn2'},  
