...
local EntitySets = { "int01_ba_lights_screen", "Int01_ba_Screen", "Int01_ba_bar_content", "Int01_ba_dry_ice", "Int01_ba_deliverytruck", "Int01_ba_trophy08",
					"Int01_ba_trophy03", "Int01_ba_trophy01" }
...
local extLoc = vec3(4.21, 220.52, 107.75)
...
function EnterClub()
	...
	showClubNotification("En el Galaxy no toleramos ningun tipo de violencia aqui. Nosotros cuidaremos de tus armas hasta que salgas.")
end
...
Citizen.CreateThread(function()
	...
	SetBlipColour(clubBlip, 15)
	SetBlipScale(clubBlip, 0.8)
	SetBlipAsShortRange(clubBlip, true)
	BeginTextCommandSetBlipName("STRING")
	AddTextComponentString("Club Technologie")
