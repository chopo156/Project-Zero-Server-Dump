...
AddEventHandler("es_admin:god", function(t)
	local msg = "deshabilitado"
	god = not god
	if(god == false)then
	...
	TriggerEvent('chat:addMessage', { 
		template = '<div style="padding: 3px; margin: 0.5vw; background-color: rgb(0, 0, 0); border-radius: 3px;"><i style="margin-left: 5px;" class="fas fa-exclamation-triangle"></i>&nbsp;{1}</div>',
		args = {"^1Sistema", "^1Sistema:^0 Modo dios ^2^*" ..msg}})
end)