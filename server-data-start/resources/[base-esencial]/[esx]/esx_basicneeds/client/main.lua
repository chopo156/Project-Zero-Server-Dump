...
RegisterNetEvent('esx_basicneeds:onDrinkDrPepper')
AddEventHandler('esx_basicneeds:onDrinkDrPepper', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_ecola_can' --ng_proc_sodacan_01a
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkMonster')
AddEventHandler('esx_basicneeds:onDrinkMonster', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_ecola_can' --ng_proc_sodacan_01a
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkLemonade')
AddEventHandler('esx_basicneeds:onDrinkLemonade', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_ecola_can' --ng_proc_sodacan_01a
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkCoffeshort')
AddEventHandler('esx_basicneeds:onDrinkCoffeshort', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_fib_coffee'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkCoffeMilk')
AddEventHandler('esx_basicneeds:onDrinkCoffeMilk', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_fib_coffee'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkHotTea')
AddEventHandler('esx_basicneeds:onDrinkHotTea', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_fib_coffee'
		IsAnimated = true
