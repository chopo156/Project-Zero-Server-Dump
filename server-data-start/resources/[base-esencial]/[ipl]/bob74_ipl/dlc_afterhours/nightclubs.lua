...
AfterHoursNightclubs = {
    ...
    LoadDefault = function()
        ...
        AfterHoursNightclubs.Interior.Name.Set(AfterHoursNightclubs.Interior.Name.technologie)
        ...
        AfterHoursNightclubs.Interior.Lights.Lasers.Set(AfterHoursNightclubs.Interior.Lights.Lasers.cyan)
                
        AfterHoursNightclubs.Interior.Lights.Bands.Set(AfterHoursNightclubs.Interior.Lights.Bands.cyan)

        AfterHoursNightclubs.Interior.Lights.Neons.Set(AfterHoursNightclubs.Interior.Lights.Neons.purple)

        AfterHoursNightclubs.Interior.Lights.Droplets.Set(AfterHoursNightclubs.Interior.Lights.Droplets.yellow)
